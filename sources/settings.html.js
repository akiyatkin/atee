...
export const ROOT = (data, env) => err(data, env) || `
	...
	<div style="display: grid; gap: 1em; margin: 2em 0">
		...
		<div>
			...
			<p>
				Может потребоваться сбросить старты о начале загрузки источников если база данных была перезапущена во время работы или когда какая-то загрузка завершилась непредусмотренной ошибкой. Cбрасывается date_start у источников.
			</p>
		</div>
	</div>
