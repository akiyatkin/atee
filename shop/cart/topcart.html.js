...
tpl.CART = (data, env) => panel.isShowPanel(data) ? `
	<button title="На ${cost((data.list||[]).reduce((val, pos) => val + pos.sum, 0))}${cards.unit()}" 
		...
		<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path d="M22.7141 1.28564H20.7764C19.8439 1.28564 19.035 1.9302 18.8269 2.83927L17.646 7.99685" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
			<path d="M1.74226 8.71443C1.91581 11.8359 2.86215 14.3939 3.54211 15.7232C3.73601 16.1023 4.04482 16.404 4.44848 16.5395C5.20144 16.7923 6.76472 17.1429 9.64293 17.1429C12.5211 17.1429 14.0844 16.7923 14.8374 16.5395C15.241 16.404 15.5498 16.1023 15.7437 15.7232C16.495 14.2544 17.5715 11.2858 17.5715 7.71436H2.71436C2.16207 7.71436 1.7116 8.16299 1.74226 8.71443Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
			<path d="M3.85714 22.2856C4.33053 22.2856 4.71429 21.9018 4.71429 21.4284C4.71429 20.955 4.33053 20.5713 3.85714 20.5713C3.38376 20.5713 3 20.955 3 21.4284C3 21.9018 3.38376 22.2856 3.85714 22.2856Z" fill="#4C6056" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
			<path d="M15 22.2856C15.4734 22.2856 15.8571 21.9018 15.8571 21.4284C15.8571 20.955 15.4734 20.5713 15 20.5713C14.5266 20.5713 14.1428 20.955 14.1428 21.4284C14.1428 21.9018 14.5266 22.2856 15 22.2856Z" fill="#4C6056" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
		</svg>
