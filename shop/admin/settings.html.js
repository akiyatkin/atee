...
export const ROOT = (data, env) => err(data, env) || `
	...
	<div style="display: grid; gap: 1em; margin: 2em 0">
		<div>
			...
			<p>
				Группы пересоберутся согласно выборкам. Пересчитается статистика.
			</p>
		</div>
		<div>
			<p>
			...
			<p>
				...
				Вручную надо сбрасывать, если данные изменились вручную на диске или произошёл сбой.
			</p>
		</div>
		<div>
			<p>
